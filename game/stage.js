...
window.STAGE = (function () {
  ...
  function renderEnd(payload) {
    ...
    wrap.appendChild(t);
    if (payload && payload.seedTotal > 0) {   // 단편(seedTotal 0)은 회수 표시 생략
  ...
  function showTitle(opts) {
    ...
    h.textContent = (window.SCRIPT && window.SCRIPT.meta && window.SCRIPT.meta.work) || "SCALAR: NODE ZERO";
