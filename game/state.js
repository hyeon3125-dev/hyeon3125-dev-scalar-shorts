...
window.STATE = (function () {
  ...
  const K = {
    progress: "shorts_progress" + SUF,
    seeds: "shorts_seeds" + SUF,
    unchosen: "shorts_unchosen" + SUF,
    cracks: "shorts_cracks" + SUF,
    save: "shorts_save" + SUF,
    flags: "shorts_flags" + SUF,
    telemetry: "shorts_telemetry" + SUF,    // 읽기 결 집계 (단편: 판정 미사용, 합산값만)
    judgement: "shorts_judgement" + SUF,    // 단편 미사용(ch===200 트리거 없음)
    marks: "shorts_marks" + SUF,            // 독자의 밑줄
    settings: "shorts_settings",
    legacyNotified: "shorts_legacy_notified",
    lang: "shorts_lang",
  };
